    ...
    <header className="sticky top-0 z-40 border-b border-border bg-white/95 backdrop-blur">
      <div className="mx-auto flex max-w-7xl items-center gap-4 px-4 py-3">
        ...
        <nav className="ml-auto flex items-center gap-1">
          ...
          <Link
            to="/cart"
            className="relative grid h-10 w-10 place-items-center rounded-lg text-navy hover:bg-secondary"
          >
            <ShoppingCart className="h-5 w-5" />
            {count > 0 && (
              <span className="absolute -right-1 -top-1 grid h-5 min-w-5 place-items-center rounded-full bg-gold px-1 text-[10px] font-bold text-navy">
                {count}
              </span>
            )}
          </Link>
          {user ? (
            <Link
              to="/profile"
              className="hidden rounded-lg border border-border px-3 py-2 text-sm font-medium text-navy hover:bg-secondary md:inline-flex"
            >
              My account
            </Link>
          ) : (
            <>
              ...
              <Link
                to="/signup"
                className="hidden rounded-lg bg-gold px-3 py-2 text-sm font-medium text-navy transition hover:bg-gold/90 md:inline-flex"
              >
                Sign up
              </Link>
            </>
          ...
          <button
            onClick={() => setOpen((o) => !o)}
            className="grid h-10 w-10 place-items-center rounded-lg text-navy hover:bg-secondary md:hidden"
            aria-label="Menu"
          >
        ...
        <div className="border-t bg-white px-4 py-3 md:hidden">
          <form onSubmit={submit} className="relative mb-3">
            ...
            <input
              ...
              className="w-full rounded-full border border-border bg-secondary py-2 pl-10 pr-4 text-sm outline-none focus:border-gold focus:bg-white"
            />
          </form>
      ...
      <div className="mx-auto grid max-w-7xl gap-8 px-4 py-12 md:grid-cols-3">
        <div>
          <div className="flex items-center gap-2">
            <div className="grid h-10 w-10 place-items-center rounded-lg bg-gold text-navy">
              <Smartphone className="h-5 w-5" />
            </div>
            <div>
        ...
        <div>
          <div className="mb-3 text-sm font-bold uppercase tracking-wider text-gold">
            Quick Links
          </div>
        ...
        <div>
          ...
          <a
            ...
            className="inline-flex items-center gap-2 rounded-lg bg-whatsapp px-4 py-2 text-sm font-bold text-white transition hover:bg-whatsapp-dark"
          >
          ...
          <div className="mt-4 flex gap-2">
            <a
              href="#"
              className="grid h-9 w-9 place-items-center rounded-full bg-white/10 hover:bg-gold hover:text-navy"
            >
