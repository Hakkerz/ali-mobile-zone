...
function Card({
  ...
  return (
    <Reveal delay={delay} className="group">
      <div className="rounded-3xl border border-glass-border glass-card p-6 text-center transition-all duration-300 hover:scale-[1.05] hover:border-neon/50 hover:shadow-[0_0_30px_color-mix(in_oklab,_var(--neon),_20%)]">
        ...
        <div className="mt-1 text-sm font-semibold text-neon">{subtitle}</div>
      </div>
    </Reveal>
  );
}
