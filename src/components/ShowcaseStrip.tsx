...
function ChargerCard() {
  return (
    <div className="relative mx-auto grid h-44 w-28 place-items-center">
      ...
      <span
        className="absolute h-16 w-16 rounded-full bg-gold/30 animate-spark-burst"
  ...
  return (
    <div className="relative mx-auto grid h-44 w-44 place-items-center">
      ...
      <div className="absolute left-2 top-6">
        ...
        <span
          className="absolute inset-0 m-auto block h-12 w-12 rounded-full border-2 border-gold animate-sonar"
          style={{ animationDelay: "0.6s" }}
        />
        <span
          className="absolute inset-0 m-auto block h-12 w-12 rounded-full border-2 border-gold animate-sonar"
