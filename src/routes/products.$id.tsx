...
const PRODUCT_DETAILS: Record<string, { description: string; features: string[] }> = {
  "r-615": {
    description:
      "The Ronin R-615 is a reliable Android wall charger built for everyday fast charging. Compact and travel-friendly, it delivers stable output to keep your devices powered efficiently without overheating.",
    features: [
  ...
  "r-1515": {
    description:
      "The Ronin R-1515 is a flagship over-ear wireless headphone with Active Noise Cancellation and premium 40mm drivers. Whether at a busy office or home, it delivers a professional-grade listening experience with up to 30 hours battery.",
    features: [
  ...
  "anker-r50i": {
    description:
      "The Anker Soundcore R50i delivers wireless freedom with Bluetooth 5.3, IPX5 water resistance, and clear calls powered by AI noise reduction. Compatible with both iPhone and Android.",
    features: [
  ...
  "airpods-4": {
    description:
      "Apple AirPods 4 feature the H2 chip with Personalized Spatial Audio, dynamic head tracking, and Voice Isolation. Comes with a USB-C charging case. Available with or without Active Noise Cancellation.",
    features: [
      "Apple H2 chip",
  ...
  "r-09-luxe": {
    description:
      "The Ronin R-09 Luxe is a premium wireless earbud with a luxurious finish, deep bass, and long battery life. Designed for those who demand both style and performance.",
    features: [
      "Premium Luxe finish",
  ...
  "r-6065": {
    description:
      "The Ronin R-6065 is a high-wattage fast charger built for modern smartphones. Supports fast charging protocols and comes with built-in safety protections.",
    features: [
  ...
  "r-2505": {
    description:
      "The Ronin R-2505 is a dual-port car charger that keeps your devices powered on every journey. Plug into any car socket for fast, reliable in-car charging.",
    features: [
      "Dual USB ports",
      "Fast car charging",
  ...
  "audionic-850": {
    description:
      "The Audionic Trance Airbud 850 is a premium TWS earbud delivering rich sound, deep bass, and long playtime. Engineered for music lovers who want immersive audio in a sleek wireless package.",
    features: [
  ...
  "r-09-ultra": {
    description:
      "The Ronin R-09 Ultra is the top-tier version of the R-09 series, delivering ultra-refined sound with enhanced ANC and a premium build. For the audiophile who settles for nothing less.",
    features: [
  ...
  "r-010-silicon": {
    description:
      "The Ronin R-010 Silicon features a comfortable silicone earbud design with a secure fit for workouts and daily use. Combines durability with crisp clear audio.",
    features: [
