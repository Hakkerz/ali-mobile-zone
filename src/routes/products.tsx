...
export const Route = createFileRoute("/products")({
  ...
  head: () => ({
    meta: [
      { title: "All Products — Ali Mobile Zone" },
      {
        name: "description",
        content: "Browse all mobile accessories: chargers, headphones, earbuds and more.",
      },
    ],
  }),
...
function ProductsPage() {
  ...
  const update = (partial: Record<string, unknown>) =>
    navigate({
      search: (prev: Record<string, unknown>) => ({ ...prev, ...partial, page: 1 }) as never,
    });
