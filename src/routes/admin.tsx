  ...
  return (
    <div className="min-h-screen bg-secondary">
      ...
      <main className="mx-auto max-w-7xl px-4 py-8">
                  ...
                  {products.map((p) => (
                    <tr key={p.id} className="hover:bg-secondary/50">
                      <td className="px-4 py-2">
                        <div className="flex items-center gap-3">
                          <div className="h-10 w-10 overflow-hidden rounded bg-white">
                            <ProductImage
                              src={p.image}
                              alt={p.name}
                      ...
                      <td className="px-4 py-2 text-right">
                        <button
                          ...
                          className="mr-1 grid h-8 w-8 place-items-center rounded-lg hover:bg-secondary"
                        >
        ...
        {tab === "orders" && (
          <OrdersPanel orders={orders} onAdd={addOrder} onRemove={removeOrder} />
        )}
      </main>
...
function OrdersPanel({
  ...
  onAdd: (o: { name: string; phone: string; total: number; notes?: string }) => void;
      ...
      <div className="rounded-2xl border bg-white">
        ...
        {orders.length === 0 ? (
          <div className="px-5 py-10 text-center text-sm text-muted-foreground">
            No orders logged yet. Add WhatsApp orders manually using the form.
          </div>
        ) : (
